...
#include "ActorEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UActorEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ActorEditorEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UActorEditorEditorMode();
	virtual ~UActorEditorEditorMode();
