...
#include "ActorEditorInteractiveTool.generated.h"


/**
 * Builder for UActorEditorInteractiveTool
 */
UCLASS()
class ACTOREDITOR_API UActorEditorInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UActorEditorInteractiveTool
 */
UCLASS(Transient)
class ACTOREDITOR_API UActorEditorInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UActorEditorInteractiveToolProperties();
...
/**
 * UActorEditorInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class ACTOREDITOR_API UActorEditorInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UActorEditorInteractiveToolProperties> Properties;
